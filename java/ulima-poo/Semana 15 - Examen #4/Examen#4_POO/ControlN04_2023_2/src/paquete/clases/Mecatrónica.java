 ...
 * @author Usuario
 */
public class Mecatrónica extends Alumnos implements Taller
{
    //Atributos
    private int horasTaller;
    
    //Constructor
    public Mecatrónica(String code, String nombre, int edad) 
    {
    ...
    public void CalcularCreditos() 
    {
        ...
        this.creditos = rand.nextInt(35-15+1)+15;
    ...
    {
        Random rand = new Random();
        this.horasTaller = rand.nextInt(45-25+1)+25;
    }
