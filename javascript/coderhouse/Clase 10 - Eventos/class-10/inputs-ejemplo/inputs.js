...
form.addEventListener("submit", (ev) => {
    ...
    // target: contiene al nodo que lanzo el formulario (en este caso, el encargado de lanzar la informacion es el formulario)
    // es decir, mostramos en la consola toda la estructura html del formulario
});
