...
const recoverFieldsMethodOne = (formData) => {
    ...
    Este enfoque es ideal para manejar formularios en JavaScript de manera rápida y eficiente. (CUANDO SOLO SE PUEDE SELECCIONAR UNA OPCION)
    */
}
...
const recoverFieldsMethodTwo = (formData) => {
    ...
    */
    ...
    // SI MUESTRA TODAS LAS OPCIONES QUE SELECCIONAMOS
}
